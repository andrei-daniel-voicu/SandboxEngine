...
Matrix& Matrix::SetRotationAngleAxis (float angle, Vector3 axis)
{
	float sinAngle, cosAngle;
...
Matrix Matrix::InvertMatrix ()
{
	...
	GLfloat A2323 = m[2][2] * m[3][3] - m[2][3] * m[3][2];
	GLfloat A1323 = m[2][1] * m[3][3] - m[2][3] * m[3][1];
	GLfloat A1223 = m[2][1] * m[3][2] - m[2][2] * m[3][1];
	GLfloat A0323 = m[2][0] * m[3][3] - m[2][3] * m[3][0];
	GLfloat A0223 = m[2][0] * m[3][2] - m[2][2] * m[3][0];
	GLfloat A0123 = m[2][0] * m[3][1] - m[2][1] * m[3][0];
	GLfloat A2313 = m[1][2] * m[3][3] - m[1][3] * m[3][2];
	GLfloat A1313 = m[1][1] * m[3][3] - m[1][3] * m[3][1];
	GLfloat A1213 = m[1][1] * m[3][2] - m[1][2] * m[3][1];
	GLfloat A2312 = m[1][2] * m[2][3] - m[1][3] * m[2][2];
	GLfloat A1312 = m[1][1] * m[2][3] - m[1][3] * m[2][1];
	GLfloat A1212 = m[1][1] * m[2][2] - m[1][2] * m[2][1];
	GLfloat A0313 = m[1][0] * m[3][3] - m[1][3] * m[3][0];
	GLfloat A0213 = m[1][0] * m[3][2] - m[1][2] * m[3][0];
	GLfloat A0312 = m[1][0] * m[2][3] - m[1][3] * m[2][0];
	GLfloat A0212 = m[1][0] * m[2][2] - m[1][2] * m[2][0];
	GLfloat A0113 = m[1][0] * m[3][1] - m[1][1] * m[3][0];
	GLfloat A0112 = m[1][0] * m[2][1] - m[1][1] * m[2][0];

	GLfloat det = m[0][0] * (m[1][1] * A2323 - m[1][2] * A1323 + m[1][3] * A1223)
